...
3. **Suspected gaps** — drafts tagged `@gap-suspected`, listed separately. These describe
   behavior that was promised but appears unbuilt, so they are not implementable work; they
...
5. **Suite shape** — total live scenarios, how many are `@smoke`, and the smoke suite's last
